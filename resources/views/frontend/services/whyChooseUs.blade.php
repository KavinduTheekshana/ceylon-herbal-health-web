            ...
            <div class="col-lg-12">
                ...
                <div class="why-choose-content">
                    ...
                    <div class="why-choose-image">
                        <figure class="image-anime reveal">
                            <img src="{{ asset('frontend/images/why-choose-image.jpg') }}" alt="">
                        </figure>
                    </div>
                ...
                <div class="why-choose-counter-box">
                    ...
                    <div class="why-choose-counter-item">
                        <div class="icon-box">
                            <img src="{{ asset('frontend/images/icon-why-choose-counter-1.svg') }}" alt="">
                        </div>
                    ...
                    <div class="why-choose-counter-item">
                        <div class="icon-box">
                            <img src="{{ asset('frontend/images/icon-why-choose-counter-2.svg') }}" alt="">
                        </div>
                        <div class="why-choose-counter-content">
                    ...
                    <div class="why-choose-counter-item">
                        <div class="icon-box">
                            <img src="{{ asset('frontend/images/icon-why-choose-counter-3.svg') }}" alt="">
                        </div>
                        <div class="why-choose-counter-content">
                    ...
                    <div class="why-choose-counter-item">
                        <div class="icon-box">
                            <img src="{{ asset('frontend/images/icon-why-choose-counter-4.svg') }}" alt="">
                        </div>
                        <div class="why-choose-counter-content">
